...
namespace Ponoko.Api.Unit.Tests.Json {
	...
	public class ErrorDeserializerTests {
		...
		public void can_deserialize_an_error_ignoring_request() {
			var json = "{\"error\":{\"message\":\"Bad Request. Error processing design file(s).\",\"errors\":[" + 
				"{\"type\":\"design_processing\"," + 
				"\"node_key\":\"any_node_key\"," +
				"\"error_code\":\"unknown_material\"," + 
				"\"error_message\":\"any error message\"," + 
				"\"name\":\"bottom_new.stl\"," + 
				"\"material_key\":\"any_material_key\"}],\"request\":{\"name\":\"xxx\",\"key\":null,\"designs\":[{\"quantity\":\"0\",\"uploaded_data\":\"/tmp/RackMultipart25372-1\",\"filename\":\"res\\bottom_new.stl\",\"material_key\":\"\",\"ref\":\"\"}]}}}";
			...
			var result = JsonConvert.DeserializeObject<Error>(payload["error"].ToString(), settings);
